...
<ul class="nav nav-list">
	...
	<li id="li_107" ${ menuActive!=null&&"107"==menuActive?"class='active'":"" }><a href="<%=path%>/FileUpload/list?"><i class="icon-shopping-cart"></i>文件上载</a></li>
	<li id="li_105" ${ menuActive=='106'?"class='active'":"" }><a href="<%=path%>/CostFill/list?ma=106"><i class="icon-tint"></i>成本管理</a></li>
	<li id="li_106" ${ menuActive=='105'?"class='active'":"" }><a href="<%=path %>/sys?ma=105"><i class="icon-cog"></i>系统管理</a></li>
