...
<ul class="nav nav-list">
	<li class="nav-header"><a href="#" class="btn btn-small"
		onclick="toggleMenu('li_401,li_402,li_403,li_404,li_405')"><i	class="icon-plus"></i>成本管理</a></li>
	
	<li id="li_401" style="display:none;" ${ menuActive=='401'?"class='active'":"" }><a href="<%=path%>/CostFill/list?ma=401">
		<i	class="icon-home"></i>成本管理</a></li>	
	<li id="li_402" style="display:none;" ${ menuActive=='402'?"class='active'":"" }><a href="<%=path%>/SmCost/list?">
		<i	class="icon-home"></i>日常成本</a></li>	
	<li id="li_403" style="display:none;" ${ menuActive=='403'?"class='active'":"" }><a href="<%=path%>/SmCosttype/list?">
		<i	class="icon-home"></i>成本类型</a></li>	
	<li id="li_404" style="display:none;" ${ menuActive=='404'?"class='active'":"" }><a href="<%=path%>/SmStatterm/list?">
		<i	class="icon-home"></i>成本统计期间</a></li>	
	<li id="li_405" style="display:none;" ${ menuActive=='405'?"class='active'":"" }><a href="<%=path%>/CostFill2/list?">
		<i	class="icon-home"></i>成本填报</a></li>	
...
<SCRIPT LANGUAGE="JavaScript">
	...
	toggleMenu('li_401,li_402,li_403,li_404,li_405');
	//-->
</SCRIPT>
