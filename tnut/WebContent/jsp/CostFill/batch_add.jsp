...
<ul class="nav">
	...
	<li class="active"><a href="<%=path%>/CostFill/batch_add?">批量填报</a></li>
...
<form action="<%=path%>/CostFill/batch_save?" method="post" id="addForm"
	...
	TYPE="hidden" NAME="CostFill.id" value="${CostFill.id }" />
	...
	<input type="hidden" id="dtp_input1" value="" />
			...
			<div class="control-group">
				<div class="controls input-append date form_date" data-date="2013-08-16"
					...
					<span	class="add-on">${msg['label.CostFill.FILL_DATE']}</span> 
...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			<td nowrap><a href="#"><i class="icon-remove"></i></a>&nbsp;|&nbsp;<a href="#"><i class="icon-plus"></i></a></td>
			<td nowrap><input type="text" name="name" id="name" style="input-xxlarge"></td>
			<td nowrap><input type="text" name="amt"  id="amt" class="input-small"></td>
		...
		<TR>
			...
			<td colspan="3"><INPUT TYPE="TEXT" NAME="CostFill.remark" ID="CostFill.remark"
		...
		<TR>
			<td colspan="4">
				...
				<input type="button" name="btn_back" class="btn btn-info" value="取消"
					onclick="window.location='<%=path%>/CostFill/list?'">
			</td>
		</TR>
	</tbody>
</table>
