...
<ul class="nav nav-list">
	...
	<li class="nav-header"><a href="#" class="btn btn-small" onclick="toggleMenu('li_601,li_602')"><i class="icon-plus"></i>客户管理</a></li>
	<li id="li_601" style="" ${ menuActive=='601'?"class='active'":"" }><a href="<%=path%>/Customer/list?"><i class="icon-user"></i>客户信息</a></li>
	<li id="li_602" style="" ${ menuActive=='602'?"class='active'":"" }><a href="<%=path%>/Dothing/list?"><i class="icon-tags"></i>工作日志</a></li>
