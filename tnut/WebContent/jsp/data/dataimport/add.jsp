...
<span class="divider">/</span></li>
<li class="active">${msg['label.DataimportInfo.TABLE_CN']}${msg['display.label.detail']}</li>
...
<li class="active"><a href="<%=path%>/DataimportInfo/add?">${msg['label.DataimportInfo.TABLE_CN']}${msg['display.label.add']}</a></li>
...
<form action="<%=path %>/DataimportInfo/save?" method="post"  id="addForm" name="addForm" onsubmit="return valForm(this);">
...
<table class="table table-bordered">
	...
	<tr>
		<td>${msg['label.DataimportInfo.IS_READ']}</td>
		<td  colspan="1">
				<INPUT TYPE="TEXT" NAME="DataimportInfo.is_read" ID="DataimportInfo.is_read" value="${DataimportInfo.is_read }"  maxLength="20"   />
		</td>
	...
	<tr>
		<td>${msg['label.DataimportInfo.REMARK']}</td>
		<td colspan="3">
		<textarea rows="3" cols="50" NAME="DataimportInfo.remark" ID="DataimportInfo.remark" style="width:85%">${DataimportInfo.remark }</textarea>
		</td>
