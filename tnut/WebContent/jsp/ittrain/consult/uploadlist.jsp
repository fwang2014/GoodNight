...
<ul class="breadcrumb">
	...
	<span class="divider">/</span></li>
	<li class="active">${msg['label.Consult.TABLE_CN']}${msg['display.label.uploadManage']}</li>
</ul>
</div>
...
<ul class="nav">
	...
	<li><a href="<%=path%>/Consult/upload?">${msg['label.Consult.TABLE_CN']}${msg['display.label.upload']}</a></li>
	<li class="active"><a href="<%=path%>/Consult/upload?">${msg['label.Consult.TABLE_CN']}${msg['display.label.uploadManage']}</a></li>
</ul>
</div>
</div>
</div>
