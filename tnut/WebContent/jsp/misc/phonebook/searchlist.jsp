...
<ul class="breadcrumb">
	...
	<span class="divider">/</span></li>
	<li class="active">${msg['label.Phonebook.TABLE_CN']}${msg['display.label.search.list']}</li>
</ul>
</div>
...
<form action="<%=path%>/Phonebook/search?" method="post" id="searchForm"	name="searchForm">
